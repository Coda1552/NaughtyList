...
public class Nutcracker extends WinterRaider implements InventoryCarrier, RangedAttackMob {
    ...
    static class CandyCaneAttackGoal extends RangedAttackGoal {
        private final Nutcracker nutcracker;
        ...
        public CandyCaneAttackGoal(RangedAttackMob p_32450_, double p_32451_, int p_32452_, float p_32453_) {
            ...
            this.nutcracker = (Nutcracker)p_32450_;
        }
