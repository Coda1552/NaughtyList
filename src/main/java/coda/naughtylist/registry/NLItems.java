...
public class NLItems {
    ...
    public static final RegistryObject<Item> SNOW_GLOBE = ITEMS.register("snow_globe", () -> new BlockItem(NLBlocks.SNOW_GLOBE.get(), new Item.Properties().tab(GROUP).rarity(Rarity.RARE)));
}
